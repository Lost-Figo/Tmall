...
<div class="yout">
    <div class="yout-1">
        ...
        <div><img src="<%=basePath %>img/gggggggggg.png"/><div class="you-tan">会员权益<div class="sanjiao">◆</div></div></div>
        <div><img src="<%=basePath %>img/cccccccc.png"/><div class="you-tan">会员权益<div class="sanjiao">◆</div></div></div>
    </div>
</div>
<!--右侧固定栏 e-->
