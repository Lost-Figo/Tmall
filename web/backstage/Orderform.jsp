...
<%
    ...
    a[3] = 22.22;
    a[4] = 22.22;
    a[5] = orderManagementDao.ordernumbytype("马桶");
    a[6] = 22.22;
    a[7] = orderManagementDao.ordernumbytype("平板电视");
    a[8] = 22.22;
%>
    ...
    <div class="cover_style" id="cover_style">
        <div class="top_style Order_form" id="Order_form_style">
            ...
            <div class="hide_style clearfix">
                <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="<%=a[0]%>" data-color="#D15B47"><span class="percent"><%=a[0]%></span>%</div><span class="name">食品类</span></div>
                <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="<%=a[1]%>" data-color="#87CEEB"><span class="percent"><%=a[1]%></span>%</div><span class="name">服装类</span></div>
                <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="<%=a[2]%>" data-color="#87B87F"><span class="percent"><%=a[2]%></span>%</div><span class="name">数码配件</span></div>
                <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="<%=a[3]%>" data-color="#d63116"><span class="percent"><%=a[3]%></span>%</div><span class="name">手机</span></div>
                <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="<%=a[4]%>" data-color="#ff6600"><span class="percent"><%=a[4]%></span>%</div><span class="name">电脑</span></div>
                <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="<%=a[5]%>" data-color="#2ab023"><span class="percent"><%=a[5]%></span>%</div><span class="name">马桶</span></div>
                <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="<%=a[6]%>" data-color="#1e3ae6"><span class="percent"><%=a[6]%></span>%</div><span class="name">厨房用品</span></div>
                <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="<%=a[7]%>" data-color="#c316a9"><span class="percent"><%=a[7]%></span>%</div><span class="name">平板电视</span></div>
                <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="<%=a[8]%>" data-color="#13a9e1"><span class="percent"><%=a[8]%></span>%</div><span class="name">卫浴</span></div>
            </div>
        </div>
        <!--内容-->
