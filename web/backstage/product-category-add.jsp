        ...
        <form action="addcate.pd" method="post" class="form form-horizontal" id="form-user-add" onsubmit="return check()">
            <div class="Operate_cont clearfix">
                ...
                <div class="formControls ">
                    <input type="text" class="input-text" id="user-name" name="product-category-name" onblur="checkname()"><p id="checkcatename" style="color: red"></p>
                </div>
            </div>
            <div id="shuxingadd">
                <script>
                ...
                <input type="button" class="ant-btn ant-btn-red" value="删除最后一个属性" onclick="remove(this.parentElement)">
                <br>
                <br>
            </div>
            <br>
